 ...
 * signature verifier for Rateboard outbound webhook deliveries.
 *
...
/**
 * Compute the canonical Rateboard webhook signature for a payload.
...
/**
 * Verify the HMAC-SHA256 signature of a Rateboard webhook delivery.
 *
