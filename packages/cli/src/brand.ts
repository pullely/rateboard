...
// `@saas/sdk` client class name (`Rateboard`) is intentionally NOT part of
...
export const CLI_BIN = "rateboard";

/** Product/brand name used in human-facing CLI copy. */
export const PRODUCT_NAME = "Rateboard";

/** Default API base URL when `--api-url` is not supplied. */
export const DEFAULT_API_URL = "https://api.rateboard.app";
