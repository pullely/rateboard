// `rateboard webhook verify` — local cryptographic verification of a
// Rateboard outbound webhook delivery (Task 0106).
//
...
//     command is usable on a fresh install with no `rateboard login`.
