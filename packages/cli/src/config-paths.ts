...
//   - `~/.config/rateboard/credentials.json` (0600)
//   - `~/.config/rateboard/config.json`     (0644)
//
// Override via `RATEBOARD_CONFIG_DIR` (used heavily by tests).
...
export function resolveConfigDir(): string {
  ...
  // the dir they expect; fall back to `~/.config/rateboard` everywhere
