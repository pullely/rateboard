...
//   - RateboardError hierarchy propagation with request-id passthrough
...
function client(fetchImpl: typeof fetch): Rateboard {
  return new Rateboard({ baseUrl: "https://api.test", fetch: fetchImpl });
}
...
describe("AuthClient", () => {
  ...
  it("client.auth is wired onto the Rateboard class", () => {
