// Typed error hierarchy for the Rateboard SDK.
//
...
// codes (forward compatibility) fall back to the generic `RateboardError`
...
export interface RateboardErrorInit {
 ...
 * `quota_exceeded`) decode to this class — `instanceof RateboardError`
 * still matches.
 */
export class RateboardError extends Error {
  ...
  constructor(init: RateboardErrorInit) {
    super(init.envelope.message);
    this.name = "RateboardError";
...
export class BadRequestError extends RateboardError {
  constructor(init: RateboardErrorInit) {
    super(init);
...
export class UnauthenticatedError extends RateboardError {
  constructor(init: RateboardErrorInit) {
    super(init);
...
export class ForbiddenError extends RateboardError {
  constructor(init: RateboardErrorInit) {
    super(init);
...
export class NotFoundError extends RateboardError {
  constructor(init: RateboardErrorInit) {
    super(init);
...
export class ConflictError extends RateboardError {
  constructor(init: RateboardErrorInit) {
    super(init);
...
export class ValidationError extends RateboardError {
...
export class PreconditionFailedError extends RateboardError {
  constructor(init: RateboardErrorInit) {
    super(init);
...
export class UnsupportedError extends RateboardError {
  constructor(init: RateboardErrorInit) {
    super(init);
...
export class InternalError extends RateboardError {
  constructor(init: RateboardErrorInit) {
    super(init);
...
export interface RateLimitErrorInit extends RateboardErrorInit {
...
export class RateLimitError extends RateboardError {
...
/**
 * Decode an HTTP `Response` into the appropriate `RateboardError` subclass.
 *
 * Forward-compatible: unknown error codes resolve to the base `RateboardError`.
...
export async function decodeError(
  ...
  switch (envelope.code as ErrorCode) {
    ...
    default:
      ...
      return new RateboardError(init);
  }
}

function decodeRateLimit(
  init: RateboardErrorInit,
  response: Response,
): RateLimitError {
