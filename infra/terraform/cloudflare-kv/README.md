...
| `orgName` | string | `rateboard` | Org identifier |
| `owner` | string | `rateboard` | GitHub owner |
| `repo` | string | `rateboard` | GitHub repo |
| `namespace` | string | `rateboard` | Logical namespace |
