...
Next.js 15 + [opennextjs/cloudflare](https://github.com/opennextjs/opennextjs-cloudflare) delivery of the Rateboard web console.
...
- Per-env Cloudflare Pages projects: `rateboard-web-console-next-{dev,stage,prod}`
